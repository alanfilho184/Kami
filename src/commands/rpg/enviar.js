module.exports = class enviar {
    ...
    create(client, int, fichaUser) {
        ...
        const s1Embed = new client.Discord.EmbedBuilder().setColor(parseInt(process.env.EMBED_COLOR)), s2Embed = new client.Discord.EmbedBuilder().setColor(parseInt(process.env.EMBED_COLOR))
